...
Fe_c1		sw -4(r14),r15			% Tag the function call address
		...
		sw -20(r14),r2		% Save buffer register r2
		sw -24(r14),r3		% Save buffer register r3
		sw -28(r14),r4		% Save buffer register r4
		sw -32(r14),r5		% Save buffer register r5
		sw -36(r14),r6		% Save buffer register r6
		sw -40(r14),r7		% Save buffer register r7
		sw -44(r14),r8		% Save buffer register r8
		sw -48(r14),r9		% Save buffer register r9
		sw -52(r14),r10		% Save buffer register r10
		sw -56(r14),r11		% Save buffer register r11
		sw -60(r14),r12		% Save buffer register r12
		sw -64(r14),r13		% Save buffer register r13
		sw -68(r14),r14		% Save buffer register r14
		sw -72(r14),r15		% Save buffer register r15
		...
		lw r2,-20(r14)		% Save buffer register r2
		lw r3,-24(r14)		% Save buffer register r3
		lw r4,-28(r14)		% Save buffer register r4
		lw r5,-32(r14)		% Save buffer register r5
		lw r6,-36(r14)		% Save buffer register r6
		lw r7,-40(r14)		% Save buffer register r7
		lw r8,-44(r14)		% Save buffer register r8
		lw r9,-48(r14)		% Save buffer register r9
		lw r10,-52(r14)		% Save buffer register r10
		lw r11,-56(r14)		% Save buffer register r11
		lw r12,-60(r14)		% Save buffer register r12
		lw r13,-64(r14)		% Save buffer register r13
		lw r14,-68(r14)		% Save buffer register r14
		lw r15,-72(r14)		% Save buffer register r15
